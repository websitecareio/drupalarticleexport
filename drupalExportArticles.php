...
class drupalExportRecipes {
      ...
      public function fetchContent($type = "recipe") {
            ...
            while ($row = $stmt->fetch())
            {
                  ...
                  $image_url = $this->fetchArticleImage($imageData["field_image_target_id"]);

                  // Large image.
                  $imageData = $this->fetchImageTargetId($row["nid"]);
                  $imageUrl = $this->fetchImage($imageData["field_image_target_id"]);
                  ...
                  // SEO data
                  $seodata = $this->fetchMeta($row["nid"]);
                  $seometa = $this->SEOfield($seodata["field_meta_tags_value"], "description");  // title | description
                  $seotitle = $this->SEOfield($seodata["field_meta_tags_value"], "title");  // title | description
      ...
      $templateOutput[] = array(
          ...
          "notes" => $notes,
           ...
           "parent" => array( ////////////
                ...
                "seometa" => $seometa // _yoast_wpseo_metadesc
                "seotitle" => $seotitle, // _yoast_wpseo_title
           )
     );
...
public function fetchImageTargetId($entity_id) {
      ...
      // Fetches meta
      public function fetchMeta($entity_id) {
